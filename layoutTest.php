...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/vam/wall.css" media="all" />
    ...
    <div id="wrapper">
        ...
        <div id="header" <?php if($header>1){ ?> class="landing slideshow" <?php } ?>>
            ...
            <div class="slide" data-exposure="4" data-exposure-1="3" data-wipe="wipe" data-wipetime="2000">
                ...
                <div class="video" data-vimeo-id="<?php if($header==4){ ?>20552521<?php } ?>"></div>
                <div class="html">
